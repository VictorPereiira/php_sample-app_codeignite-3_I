      ...
      <div class="col-md-12">
					...
					<div class="col-md-6">
						<div class="form-group">
							...
							<textarea name="description" id="description" rows="5" class="form-control" required value=><?= isset($game) ? $game['description'] : '' ?></textarea>
						</div>
					</div>
					...
					<div class="col-md-6">
						<div class="form-group">
							...
							<input type="text" class="form-control" name="release_date" id="release_date" placeholder="Release Date" required value="<?= isset($game) ? $game['release_date'] : '' ?>">
						</div>
					</div>

					<div class="col-md-6">
							<button type="submit" class="btn btn-success btn-xs"><i class="fas fa-check"></i> Save</button>
							<a href="<?= base_url() ?>" class="btn btn-danger btn-xs"><i class="fas fa-times"></i> Cancel</a>
						</div>
					</div>
				</form>
	  </div>
